...
![Figure 4: Depiction of the structure of a decision tree, labeled with each component. Image sourced from https://www.javatpoint.com/machine-learning-decision-tree-classification-algorithm](./figures/fig4.png)
...
![Figure 5: Example classification tree](./figures/fig5.png)
...
![Figure 6: On the left is an example of an overfit tree. On the right is this tree, pruned.](./figures/fig6.png)
