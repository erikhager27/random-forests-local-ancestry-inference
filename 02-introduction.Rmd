...
![Figure 2: This is a DAG depicting the confounding effect of ancestry in GWAS. Doubt can be cast on a potential relationship between a genotype and a trait if ancestry has a true causal relationship with both.](./figures/fig2.png)
...
![Figure 3: Local ancestry inference can allow researchers to find the allele ancestries at each locus of an individual's genome, denoted by blocks of color in the genome following LAI.](./figures/fig3.png)
